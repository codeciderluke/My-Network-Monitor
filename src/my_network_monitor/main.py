"""Application entry point: python -m my_network_monitor.main"""
...
from my_network_monitor.logging_config import setup_logging
...
def main(argv: list[str] | None = None) -> int:
    ...
    app.setApplicationName("My Network Monitor")
...
def _warn_if_no_capture(window: object) -> None:
    ...
    try:
        ...
        from my_network_monitor.capture.scapy_capture_service import is_pcap_available
