...
from my_network_monitor.storage import export_service
...
from my_network_monitor.ui.widgets.packet_detail_dialog import PacketDetailDialog
from my_network_monitor.ui.widgets.summary_panel import SummaryPanel
from my_network_monitor.ui.widgets.traffic_filter_bar import TrafficFilterBar
from my_network_monitor.ui.widgets.traffic_log_table import TrafficLogTable
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, config: AppConfig, demo: bool = False) -> None:
        ...
        self.setWindowTitle("My Network Monitor")
    ...
    def _build_toolbar(self) -> None:
        ...
        title.setText(
            f'<span style="color:{Palette.TEXT_PRIMARY};">My </span>'
            f'<span style="color:{Palette.ACCENT};">Network</span>'
